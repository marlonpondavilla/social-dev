      ...
      <div className="profile-container flex flex-col items-center justify-center h-screen gap-2 mt-[6rem]">
        <div className="relative">
          <Image 
            ...
            alt=""
          />
          <span className="bottom-1 right-3 absolute w-4.5 h-4.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full" title="Active now"></span>
        </div>  
        <div className="flex flex-col items-center justify-center text-base font-semibold text-gray-900 dark:text-white space-y-2">
        ...
        <div className="create-post-container flex-col items-center justify-center gap-2 border-2 text-md p-4    font-light mt-4">
          <div className="post-input">
            <input
              type="text"
              placeholder="Write or upload dev related stuff to create a post."
              className="border-2 border-gray-300 rounded-full p-3 w-[24rem] font-light text-md bg-gray-100"  
            />
            <button className="bg-green-500 py-3 w-[6rem] rounded-full hover:bg-green-400 cursor-pointer font-semibold text-gray-800">Post</button>
          </div>
